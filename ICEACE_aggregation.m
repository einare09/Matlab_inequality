...
%% USER INPUT REQUIRED
SYIA = 1;          %Start Year in Aggregation
...
research = 'AE2013'; %For what conference and/or journal is this set of seeds

%% Seeds for Economics E-Journal paper 2013
...
%% Seeds for Artificial Economics 2013
Seeds = [3692531:3692534,3692541:3692544,3692551:3692554,3692561:3692564,...
         3692571:3692574,3698711:3698714,3698721:3698724,3698741:3698744,...
         3698771:3698774,3698781:3698784,3694131:3694134,3694151:3694154,...
         3694191:3694194,3694161:3694164,3694101:3694104,3694201:3694220,...
         3694301:3694320,3694401:3694420];
...
for RunNumber = Seeds
    ...
    SimAlpha(count) = SimulationRunPar.CapitalistProb;
...
%Idx_a01 = find(SimAlpha == 0.1);
%Idx_a03 = find(SimAlpha == 0.3);
Idx_b025_a01 = 1:4:length(Seeds);%Idx_b025(find(Idx_b025 == Idx_a01));
Idx_b025_a03 = 2:4:length(Seeds);%Idx_b025(find(Idx_b025 == Idx_a03));
Idx_b03_a01 = 3:4:length(Seeds);%Idx_b03(find(Idx_b03 == Idx_a01));
Idx_b03_a03 = 4:4:length(Seeds);%Idx_b03(find(Idx_b03 == Idx_a03));
Idx_all = [Idx_b025_a01;Idx_b025_a03;Idx_b03_a01;Idx_b03_a03];
NrSeeds = numel(Idx_b025_a01);
%% Create Table
...
for w = 1:4
    ...
    AdditionalValues(12,w) = mean(var(GDP_Growth_yearly(Idx_all(w,:),:)));
    ...
    AdditionalValuesStd(12,w) = std(var(GDP_Growth_yearly(Idx_all(w,:),:)))/sqrt(NrSeeds);
end
...
TablesName = [research,'_ICEACE_Tabels_NrSeeds_',num2str(NrSeeds),'_days_',num2str(SDIA),'_',num2str(EDIA),'.txt'];
TablesName2 = [research,'_ICEACE_Tabels_NrSeeds_',num2str(NrSeeds),'_days_',num2str(SDIA),'_',num2str(EDIA),'.mat'];
