...
%Total number of housing units, capitalists and non-capitalists
nrhousingunits = NrAgents.Households*REmarket.HousingUnit;
nrcapitalists =  floor(NrAgents.Households*Households.Parameters.IsCapitalistProb);
nrnoncapitalists = NrAgents.Households-nrcapitalists;
%init housingamount
