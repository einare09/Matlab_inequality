...
if numel(IdxNonEmptyShelves)>0
    ...
    for h=IdxAgents_new
        ...
        QuarterlyCashOnHand = ...
            sum(Households.QuarterlyLaborIncome(:,h))+Households.Parameters.CapitalistConsumptionBudget*Households.QuarterlyCapitalIncome(h)-Households.HousingPayment(h);
