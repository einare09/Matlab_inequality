...
for RunNumber = [3692717:3692719]    
    ...
    %plot(XVector_year,sum(HouseholdsLiquidity,2)+sum(FirmsLiquidity,2)+sum(CstrFirmsLiquidity,2),coloredotted)
...
%     %title('Aggregate debt of firms and households','fontsize',font_sz)
    ...
    %plot(XVector_year(1:TimeConstants.NrDaysInMonth:end),RealBenefits,colore)
    %xlabel('months','fontsize',font_sz)
    %ylabel('Real Benefits','fontsize',font_sz)
    %set(gca,'xtick',visualization_vector,'fontsize',font_sz)
    subplot(3,1,2); hold on; grid on; box on
...
%     subplot(3,1,3); hold on; grid on; box on
%     plot(XVector_year(1:TimeConstants.NrDaysInMonth:end),TotalHHEquity./NrAgents.Households,colore)
%     xlabel('years','fontsize',font_sz)
%     ylabel('Total Equity of Households','fontsize',font_sz)
%     set(gca,'xtick',visualization_vector,'fontsize',font_sz)
    
   
    
    %subplot(2,1,2); hold on; grid on; box on
    %plot(XVector_year(1:TimeConstants.NrDaysInMonth:end),RegHHEquity./TotalHHEquity,colore)
    %xlabel('years','fontsize',font_sz)
    %ylabel('Equity of Non-Capitalist Households','fontsize',font_sz)
    %set(gca,'xtick',visualization_vector,'fontsize',font_sz)
    ...
    %% Income share of households QI=Quarterly Income
    ...
    %% Mortgage share of households M=Mortgages
